...
<nav class="navbar navbar-duomi nav-fixed-top" role="navigation">
   <div class="navbar-header">
      <a class="navbar-brand" href="/SpringHibernate/index.jsp">摩天股</a>
   </div>
	<div>
		<ul class="nav navbar-nav navbar-left">
			...
			<li><a href="/SpringHibernate/download">下载</a></li>
		</ul>
		<div>
        ...
        <div class="row">
            ...
            <div class="col-md-10 navbar-left">
            	...
            	<div>
            		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            		<div class="btn-group">			
						<form class="navbar-form" role="search" action="/SpringHibernate/getStockImg">
							<div class="form-group">
								<input type="text" name="code" class="form-control" placeholder="输入股票代码">
							</div>
					...
					<div class="btn-group">
					   <button type="button" class="btn btn-primary dropdown-toggle" 
					      data-toggle="dropdown">
					      展示方式 <span class="caret"></span>
					   </button>
					   <ul class="dropdown-menu" role="menu">
					      <li><a href="/SpringHibernate/getStockImg?type=0&code=sh600308">分时图</a></li>
					      <li><a href="/SpringHibernate/getStockImg?type=1">日线</a></li>
					      <li><a href="/SpringHibernate/getStockImg?type=2&code=sh600308">周线</a></li>
					      <li><a href="/SpringHibernate/getStockImg?type=3&code=sh600308">月线</a></li>
					   </ul>
					</div>
				</div>
               ...
               <%--  <div id="stock" style="min-width:700px;height:400px">${realstockdata.open}</div> --%>
                <div><img src="${stocksrc}"></a></div>
            </div>
        </div>
    </div>
